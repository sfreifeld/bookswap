...
Revision ID: 39571357ac46
Revises: 
Create Date: 2024-05-08 13:54:08.868003
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['moderator_id'], ['users.id'], name=op.f('fk_events_moderator_id_users')),
