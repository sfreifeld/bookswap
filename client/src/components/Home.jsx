...
function Home() {
    ...
    return (
        <>
            <section id="hero" className="h-screen mx-12">
            ...
            <section id="tutorial" className="h-screen mx-12">  
                ...
                <div className="flex flex-col p-2 sm:flex-row space-x-4">
                    <a href="#" className="inline-flex items-center justify-center px-4 py-2.5 text-gray-600 text-center border border-gray-300 rounded-lg">
