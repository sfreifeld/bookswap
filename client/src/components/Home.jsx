...
//                     </a>  
//                     <a href="#addEvent"className="inline-flex items-center justify-center px-4 py-2.5 text-gray-600 text-center border border-gray-300 rounded-lg">
//                         Create Event
...
//             <AddEvent id="addEvent" onAddEvent={handleAddEvent} /> 
